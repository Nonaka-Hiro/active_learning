...
for deform in deforms:  
    print(deform)
    path_name="/vol0200/data/hp230257/nonaka/2025_TiC_init_data/TiC/2_grid_data/2_Hselect/*Ti3C2*/"+str(deform)+"/OUTCAR"       #folder[1]~[11]
    print(path_name)
    ...
    for i in range(len(poscar_path)):
        ...
        folder_name=folder[6]+"_"+folder[7]+"_"+folder[8]+"_"+folder[9]+"_"+folder[10]
        # 多分 TiC_2_grid_data_2_Hselct_abmd_Ti3C2_3x3x3_1000K_2_e1_2_e2_1_e3_1_e4_2_e5_2_e6_3 みたいになる
